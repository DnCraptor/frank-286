...
// INI file path
#define CONFIG_PATH "286/config.ini"
...
bool config_save_all(void) {
    ...
    // Hardware settings (frank-286-specific)
    write_line(&fp, "\n[frank-286]\n");
...
// INI parser callback for [frank-286] section
int parse_frank_286_ini(void* user, const char* section,
                      const char* name, const char* value) {
    (void)user;

    // Accept both new and legacy section names
    if (strcmp(section, "frank-286") != 0 && strcmp(section, "murm286") != 0) return 1;
